...
class Categorycheapestprice extends Module
{
    ...
    {
        Configuration::deleteByName('DUMMYMODULENAME_LIVE_MODE');
    ...
    public function getContent()
    {
         ...
         */
        if (((bool)Tools::isSubmit('submitDummymodulenameModule')) == true) {
            $this->postProcess();
        }
    ...
    protected function renderForm()
    {
        ...
        $helper->submit_action = 'submitDummymodulenameModule';
            ...
            'form' => array(
                ...
                'input' => array(
                    array(
                        ...
                        'name' => 'DUMMYMODULENAME_LIVE_MODE',
                        'is_bool' => true,
                    ...
                    array(
                        ...
                        'name' => 'DUMMYMODULENAME_ACCOUNT_EMAIL',
                        'label' => $this->l('Email'),
                    ),
                    array(
                        'type' => 'password',
                        'name' => 'DUMMYMODULENAME_ACCOUNT_PASSWORD',
    ...
    {
        return array(
            'DUMMYMODULENAME_LIVE_MODE' => Configuration::get('DUMMYMODULENAME_LIVE_MODE', true),
            'DUMMYMODULENAME_ACCOUNT_EMAIL' => Configuration::get('DUMMYMODULENAME_ACCOUNT_EMAIL', 'contact@prestashop.com'),
            'DUMMYMODULENAME_ACCOUNT_PASSWORD' => Configuration::get('DUMMYMODULENAME_ACCOUNT_PASSWORD', null),
        );
    }
